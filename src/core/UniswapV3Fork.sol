...
abstract contract UniswapV3Fork is SettlerAbstract {
        ...
        returns (IUniswapV3Pool)
    {
        ...
        if (_isEraVmFork(forkId)) {
            return IUniswapV3Pool(AddressDerivation.deriveDeterministicContractZkSync(factory, salt, initHash, 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470));
        } else {
