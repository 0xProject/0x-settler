...
abstract contract UniswapV2 is VIPBase {
        ...
        internal
    {
        ...
        // also break UniV2.
        uint256 sellAmount = (IERC20(address(bytes20(encodedPath))).balanceOf(address(this)) * bips).unsafeDiv(10_000);
        assembly ("memory-safe") {
            ...
            // final swap
            if fromPool {
                // perform swap at the fromPool sending bought tokens to recipient
