...
import {AbstractSepoliaSettlerMetaTxn} from "./MetaTxn.sol";
...
contract AbstractSepoliaSettlerIntent is SettlerIntent, AbstractSepoliaSettlerMetaTxn {
    constructor(bytes20 gitCommit) AbstractSepoliaSettlerMetaTxn(gitCommit) {}
    ...
    function _dispatch(uint256 i, uint256 action, bytes calldata data)
        internal
        override(AbstractSepoliaSettlerMetaTxn, SettlerBase, SettlerAbstract)
        returns (bool)
    {
    ...
    function _msgSender() internal view override(SettlerIntent, AbstractSepoliaSettlerMetaTxn) returns (address) {
    ...
    function _dispatchVIP(uint256 action, bytes calldata data, bytes calldata sig)
        internal
        override(AbstractSepoliaSettlerMetaTxn, SettlerMetaTxn)
        returns (bool)
    {
