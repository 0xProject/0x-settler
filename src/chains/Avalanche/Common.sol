...
import {uniswapV4AvalanchePoolManager, uniswapV4ForkId} from "../../core/univ4forks/UniswapV4.sol";

// Solidity inheritance is stupid
import {SettlerSwapAbstract} from "../../SettlerAbstract.sol";
import {Permit2PaymentAbstract} from "../../core/Permit2PaymentAbstract.sol";

abstract contract AvalancheMixin is FreeMemory, SettlerBase, DodoV2, UniswapV4, BalancerV3, Bebop {
    constructor() {
    ...
    function _uniV4ForkInfo(uint8 forkId) internal pure override returns (IPoolManager poolManager) {
        if (forkId == uniswapV4ForkId) {
            poolManager = uniswapV4AvalanchePoolManager;
        } else {
            revertUnknownForkId(forkId);
        }
    }
