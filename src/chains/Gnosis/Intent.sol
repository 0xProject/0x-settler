...
import {GnosisSettlerMetaTxn} from "./MetaTxn.sol";
...
contract GnosisSettlerIntent is SettlerIntent, GnosisSettlerMetaTxn {
    ...
    function _dispatch(uint256 i, uint256 action, bytes calldata data)
        internal
        override(GnosisSettlerMetaTxn, SettlerBase, SettlerAbstract)
        returns (bool)
    {
    ...
    function _dispatchVIP(uint256 action, bytes calldata data, bytes calldata sig)
        internal
        override(GnosisSettlerMetaTxn, SettlerMetaTxn)
        returns (bool)
    {
    ...
    function _isRestrictedTarget(address target)
        ...
        view
        virtual
        override(GnosisSettlerMetaTxn, SettlerIntent)
        returns (bool)
    {
