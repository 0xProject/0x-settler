...
contract KatanaSettlerIntent is SettlerIntent, KatanaSettlerMetaTxn {
    constructor(bytes20 gitCommit) KatanaSettlerMetaTxn(gitCommit) {}
    ...
    function _dispatch(uint256 i, uint256 action, bytes calldata data)
        internal
        override(KatanaSettlerMetaTxn, SettlerBase, SettlerAbstract)
        returns (bool)
    {
    ...
    function _msgSender() internal view override(SettlerIntent, KatanaSettlerMetaTxn) returns (address) {
    ...
    function _isRestrictedTarget(address target)
        ...
        view
        virtual
        override(KatanaSettlerMetaTxn, SettlerIntent)
        returns (bool)
    {
