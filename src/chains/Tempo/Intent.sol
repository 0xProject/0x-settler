...
contract TempoSettlerIntent is SettlerIntent, TempoSettlerMetaTxn {
    ...
    function _dispatch(uint256 i, uint256 action, bytes calldata data)
        internal
        override(TempoSettlerMetaTxn, SettlerBase, SettlerAbstract)
        returns (bool)
    {
    ...
    function _msgSender() internal view override(SettlerIntent, TempoSettlerMetaTxn) returns (address) {
    ...
    function _dispatchVIP(uint256 action, bytes calldata data, bytes calldata sig)
        internal
        override(TempoSettlerMetaTxn, SettlerMetaTxn)
        returns (bool)
    {
    ...
    function _isRestrictedTarget(address target)
        ...
        view
        virtual
        override(TempoSettlerMetaTxn, SettlerIntent)
        returns (bool)
    {
    ...
    function _fallback(bytes calldata data)
        internal
        virtual
        override(Permit2PaymentAbstract, TempoSettlerMetaTxn)
