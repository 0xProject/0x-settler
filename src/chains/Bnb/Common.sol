    ...
    FluxPool
{
        ...
        returns (bool)
    {
        if (super._dispatch(i, action, data, slippage)) {
            ...
            (IERC20 sellToken, uint256 bps, bytes32 poolId, bool zeroForOne, IERC20 buyToken, uint256 minBuyAmount) =
                abi.decode(data, (IERC20, uint256, bytes32, bool, IERC20, uint256));

            sellToFluxPool(sellToken, bps, poolId, zeroForOne, buyToken, minBuyAmount);
