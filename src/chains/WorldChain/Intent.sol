...
import {WorldChainSettlerMetaTxn} from "./MetaTxn.sol";
...
contract WorldChainSettlerIntent is SettlerIntent, WorldChainSettlerMetaTxn {
    constructor(bytes20 gitCommit) WorldChainSettlerMetaTxn(gitCommit) {}
    ...
    function _dispatch(uint256 i, uint256 action, bytes calldata data)
        internal
        override(WorldChainSettlerMetaTxn, SettlerBase, SettlerAbstract)
        returns (bool)
    {
    ...
    function _msgSender() internal view override(SettlerIntent, WorldChainSettlerMetaTxn) returns (address) {
    ...
    function _dispatchVIP(uint256 action, bytes calldata data, bytes calldata sig)
        internal
        override(WorldChainSettlerMetaTxn, SettlerMetaTxn)
        returns (bool)
    {
    ...
    function _isRestrictedTarget(address target)
        ...
        view
        virtual
        override(WorldChainSettlerMetaTxn, SettlerIntent)
        returns (bool)
    {
    ...
    function _fallback(bytes calldata data)
        internal
        virtual
        override(Permit2PaymentAbstract, WorldChainSettlerMetaTxn)
