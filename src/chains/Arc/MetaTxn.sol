...
import {ArcMixin} from "./Common.sol";
...
contract ArcSettlerMetaTxn is SettlerMetaTxn, ArcMixin {
    ...
    function _fallback(bytes calldata data)
        internal
        virtual
        override(Permit2PaymentAbstract, ArcMixin)
