...
import {LineaSettlerMetaTxn} from "./MetaTxn.sol";
...
contract LineaSettlerIntent is SettlerIntent, LineaSettlerMetaTxn {
    ...
    function _dispatch(uint256 i, uint256 action, bytes calldata data, AllowedSlippage memory slippage)
        internal
        override(LineaSettlerMetaTxn, SettlerBase)
        returns (bool)
    {
    ...
    function _msgSender() internal view override(SettlerIntent, LineaSettlerMetaTxn) returns (address) {
    ...
    function _isRestrictedTarget(address target)
        ...
        view
        virtual
        override(LineaSettlerMetaTxn, SettlerIntent)
        returns (bool)
    {
