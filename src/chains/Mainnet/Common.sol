    ...
    EulerSwap
{
        ...
        returns (bool)
    {
        ...
        if (action == uint32(ISettlerActions.RFQ.selector)) {
            ...
            (address recipient, uint256 bps, bool buyGem, uint256 amountOutMin, bool sky) =
                abi.decode(data, (address, uint256, bool, uint256, bool));

            sellToMakerPsm(recipient, bps, buyGem, amountOutMin, sky);
