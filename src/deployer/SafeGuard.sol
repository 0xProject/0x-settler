...
///
/// This Safe Guard does _NOT_ protect against the following scenarios:
///
///   * More than one, but less than a quorum of malicious/unfaithful owners can permanently brick
...
abstract contract ZeroExSettlerDeployerSafeGuardEraVm is ZeroExSettlerDeployerSafeGuardBase {
    ...
    function _isSupportedProxyCodeHash(bytes32 safeCodeHash) internal pure virtual override returns (bool) {
        return safeCodeHash == _SAFE_PROXY_1_3_ERAVM_CODEHASH || safeCodeHash == _SAFE_PROXY_1_4_ERAVM_CODEHASH;
    }
