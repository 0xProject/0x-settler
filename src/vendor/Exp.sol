...
library Exp {
    ...
    function _expRayToWad(int256 x) private pure returns (int256 r) {
        ...
        // S = 10¹⁸⋅Δ/2⁶² ≈ 0.1256 ulp (1 ulp = 10⁻¹⁸ of the result). The margin is the least integer
        ...
        // deficit envelope ((31/10)⋅10¹⁸ + 2¹⁸⋅margin)/2^(126 - k) doubles each octave and
        // exceeds 1ulp at k = 65, where the guard cuts in. On the central
