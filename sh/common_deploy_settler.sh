...
register_exit_cleanup 'rm -f '"$(_escape "$flat_taker_source")"
...
register_exit_cleanup 'rm -f '"$(_escape "$flat_metatx_source")"
...
register_exit_cleanup 'rm -f '"$(_escape "$flat_intent_source")"
