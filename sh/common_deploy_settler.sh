...
FOUNDRY_SOLC_VERSION=0.8.25 forge build "$flat_taker_source"
...
FOUNDRY_SOLC_VERSION=0.8.25 forge build "$flat_metatx_source"
...
FOUNDRY_SOLC_VERSION=0.8.25 forge build "$flat_intent_source"
