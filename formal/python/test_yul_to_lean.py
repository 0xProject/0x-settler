...
def make_model_config(
    ...
    *,
    ...
    generator_label: str = "formal/python/test_yul_to_lean.py",
...
from formal.python import model_config as modelcfg
from formal.python.model_ir import ConditionalBlock
from formal.python.translator import translate_yul_to_models
