...
theorem homEvalI_PPc_anti {n1 n2 D : Int} (hD : 0 < D) (h21 : n2 ≤ n1)
    (hb1 : n1 ≤ 2332259347626381040680638252 * D)
    (hb2 : -(2332259347626381040680638252 * D) ≤ n2) :
  ...
  have hb1' : -(2332259347626381040680638252 * D) ≤ n1 := by omega
  have hb2' : n2 ≤ 2332259347626381040680638252 * D := by omega
  have hUD : (0 : Int) ≤ 2332259347626381040680638252 * D :=
    Int.mul_nonneg (by omega) (by omega)
  -- squares and cross products
  have hUDsq : (2332259347626381040680638252 * D) * (2332259347626381040680638252 * D) =
      5439433664590632483214364818429642280766352590085615504 * (D * D) := by
    have h : (2332259347626381040680638252 * D) * (2332259347626381040680638252 * D) =
        ((2332259347626381040680638252 : Int) * 2332259347626381040680638252) * (D * D) := by
      simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
    rw [h, show ((2332259347626381040680638252 : Int) * 2332259347626381040680638252) =
      5439433664590632483214364818429642280766352590085615504 from by decide]
  ...
  have hss_ub : n1 * n1 + n2 * n2 ≤
      10878867329181264966428729636859284561532705180171231008 * (D * D) := by
    omega
  have hsum_ub : n1 + n2 ≤ 4664518695252762081361276504 * D := by omega
  have hsum_lb : -(4664518695252762081361276504 * D) ≤ n1 + n2 := by omega
  have hH4 := mul_bound (a := n1 + n2) (A := 4664518695252762081361276504 * D)
    (b := n1 * n1 + n2 * n2)
    (B := 10878867329181264966428729636859284561532705180171231008 * (D * D))
    hsum_lb hsum_ub hss_nn hss_ub
  have hH4ub : (4664518695252762081361276504 * D) *
      (10878867329181264966428729636859284561532705180171231008 * (D * D)) =
      50744680040140494628632404491524039352162157045141941315210963455068760107946636032 *
        (D * (D * D)) := by
    have h : (4664518695252762081361276504 * D) *
        (10878867329181264966428729636859284561532705180171231008 * (D * D)) =
        ((4664518695252762081361276504 : Int) *
          10878867329181264966428729636859284561532705180171231008) * (D * (D * D)) := by
      simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
    rw [h, show ((4664518695252762081361276504 : Int) *
      10878867329181264966428729636859284561532705180171231008) =
      50744680040140494628632404491524039352162157045141941315210963455068760107946636032
      from by decide]
  rw [hH4ub] at hH4
  -- powers as products
  ...
  have hT2 : (1798175745614395766239082622521528960720477616324792863638563111730471590055378944 : Int) * (n1 * n1) * (D * D) - (1798175745614395766239082622521528960720477616324792863638563111730471590055378944 : Int) * (n2 * n2) * (D * D) ≤
      (n1 - n2) * (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) * (D * D * D) := by
    ...
    have e2 : ((1798175745614395766239082622521528960720477616324792863638563111730471590055378944 : Int) * (n1 - n2) * (D * D)) * (4664518695252762081361276504 * D) =
        (n1 - n2) * (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) * (D * D * D) := by
      have h : ((1798175745614395766239082622521528960720477616324792863638563111730471590055378944 : Int) * (n1 - n2) * (D * D)) * (4664518695252762081361276504 * D) =
          (n1 - n2) * ((1798175745614395766239082622521528960720477616324792863638563111730471590055378944 : Int) * 4664518695252762081361276504) * (D * D * D) := by
        simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
      rw [h, show ((1798175745614395766239082622521528960720477616324792863638563111730471590055378944 : Int) * 4664518695252762081361276504) = (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) from by decide]
    omega
  -- T3 (nonpositive)
  ...
  have hT4 : (4542704643877621417440 : Int) * (n1 * n1 * n1 * n1) - (4542704643877621417440 : Int) * (n2 * n2 * n2 * n2) ≤
      (n1 - n2) * (230518093670430269346172361616623384949748492779940349001327722814892922006687849697396950698283617198080 : Int) * (D * D * D) := by
    ...
    have e2 : ((4542704643877621417440 : Int) * (n1 - n2)) *
      ...
      rw [h, show ((4542704643877621417440 : Int) *
        50744680040140494628632404491524039352162157045141941315210963455068760107946636032) =
        (230518093670430269346172361616623384949748492779940349001327722814892922006687849697396950698283617198080 : Int) from by decide]
    omega
  ...
  have hsum : (n1 - n2) * (-(211724653123857194763950383719813360812387246807907859655976840812609762088646804783336607575824561935839395840 : Int)) * (D * D * D) +
      (n1 - n2) * (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) * (D * D * D) +
      (n1 - n2) * (230518093670430269346172361616623384949748492779940349001327722814892922006687849697396950698283617198080 : Int) * (D * D * D) ≤ 0 := by
    have e1 : (n1 - n2) * (-(211724653123857194763950383719813360812387246807907859655976840812609762088646804783336607575824561935839395840 : Int)) * (D * D * D) +
        (n1 - n2) * (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) * (D * D * D) +
        (n1 - n2) * (230518093670430269346172361616623384949748492779940349001327722814892922006687849697396950698283617198080 : Int) * (D * D * D) =
        (n1 - n2) * (-(203336798222995100376815126870665102010038972423293841381903154436739481724474788615086429445418312716938665984 : Int)) * (D * D * D) := by
      have h : (n1 - n2) * (-(211724653123857194763950383719813360812387246807907859655976840812609762088646804783336607575824561935839395840 : Int)) * (D * D * D) +
          (n1 - n2) * (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) * (D * D * D) +
          (n1 - n2) * (230518093670430269346172361616623384949748492779940349001327722814892922006687849697396950698283617198080 : Int) * (D * D * D) =
          (n1 - n2) * ((-(211724653123857194763950383719813360812387246807907859655976840812609762088646804783336607575824561935839395840 : Int)) + (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) + (230518093670430269346172361616623384949748492779940349001327722814892922006687849697396950698283617198080 : Int)) * (D * D * D) := by
        rw [Int.mul_add, Int.mul_add, Int.add_mul, Int.add_mul]
      rw [h, show ((-(211724653123857194763950383719813360812387246807907859655976840812609762088646804783336607575824561935839395840 : Int)) + (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) + (230518093670430269346172361616623384949748492779940349001327722814892922006687849697396950698283617198080 : Int)) = -(203336798222995100376815126870665102010038972423293841381903154436739481724474788615086429445418312716938665984 : Int) from by decide]
    rw [e1]
    have h1 : (n1 - n2) * (-(203336798222995100376815126870665102010038972423293841381903154436739481724474788615086429445418312716938665984 : Int)) ≤ 0 :=
  ...
  generalize (n1 - n2) * (8387624382768423956865910676786642178963324636121238333724685048147465471250009480400480733455550935283531776 : Int) * (D * D * D) = g2 at *
  generalize (n1 - n2) * (230518093670430269346172361616623384949748492779940349001327722814892922006687849697396950698283617198080 : Int) * (D * D * D) = g4 at *
  omega
...
theorem homEvalI_QQc_mono {n1 n2 D : Int} (hD : 0 < D) (h21 : n2 ≤ n1)
  ...
  have hb2' : n2 ≤ 2332259347626381040680638252 * D := by omega
  have hUDsq : (2332259347626381040680638252 * D) * (2332259347626381040680638252 * D) =
      (5439433664590632483214364818429642280766352590085615504 : Int) * (D * D) := by
    have h : (2332259347626381040680638252 * D) * (2332259347626381040680638252 * D) =
        ((2332259347626381040680638252 : Int) * 2332259347626381040680638252) * (D * D) := by
      simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
    rw [h, show ((2332259347626381040680638252 : Int) * 2332259347626381040680638252) =
      (5439433664590632483214364818429642280766352590085615504 : Int) from by decide]
  have hsq1 := sq_le_of_abs_le hb1' hb1
  have hsq2 := sq_le_of_abs_le hb2 hb2'
  ...
  have hss_nn : 0 ≤ n1 * n1 + n2 * n2 := by
    ...
    have s3 := sq_nonneg' n2
    omega
  have hss_ub : n1 * n1 + n2 * n2 ≤ (10878867329181264966428729636859284561532705180171231008 : Int) * (D * D) := by omega
  have hsum_ub : n1 + n2 ≤ (4664518695252762081361276504 : Int) * D := by omega
  have hsum_lb : -((4664518695252762081361276504 : Int) * D) ≤ n1 + n2 := by omega
  have hmono : 0 ≤ n1 - n2 := by omega
  have hUD : (0 : Int) ≤ 2332259347626381040680638252 * D :=
    Int.mul_nonneg (by omega) (by omega)
  ...
  have hH4 := mul_bound (a := n1 + n2) (A := (4664518695252762081361276504 : Int) * D)
    (b := n1 * n1 + n2 * n2) (B := (10878867329181264966428729636859284561532705180171231008 : Int) * (D * D)) hsum_lb hsum_ub hss_nn hss_ub
  have hH4m : ((4664518695252762081361276504 : Int) * D) * ((10878867329181264966428729636859284561532705180171231008 : Int) * (D * D)) =
      (50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) *
        (D * D * D) := by
    have h : ((4664518695252762081361276504 : Int) * D) * ((10878867329181264966428729636859284561532705180171231008 : Int) * (D * D)) =
        ((4664518695252762081361276504 : Int) * (10878867329181264966428729636859284561532705180171231008 : Int)) * (D * D * D) := by
      simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
    rw [h, show ((4664518695252762081361276504 : Int) * (10878867329181264966428729636859284561532705180171231008 : Int)) =
      (50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int)
      from by decide]
  rw [hH4m] at hH4
  ...
  have hT2 : (-(690627211385037298547738551962892852267586075469791719173459072596031701017399264062472192 : Int)) * (n1 * n1) * (D * D * D) -
      ...
      -((n1 - n2) * (3221443538955787693742639129943142603051027084828881274516979369381209677277149495924347379910667674547214343122976768 : Int) * (D * D * D * D)) := by
    ...
    have e2 : (-(690627211385037298547738551962892852267586075469791719173459072596031701017399264062472192 : Int)) * (n1 - n2) * (D * D * D) * ((4664518695252762081361276504 : Int) * D) =
        -((n1 - n2) * (3221443538955787693742639129943142603051027084828881274516979369381209677277149495924347379910667674547214343122976768 : Int) * (D * D * D * D)) := by
      have h : (-(690627211385037298547738551962892852267586075469791719173459072596031701017399264062472192 : Int)) * (n1 - n2) * (D * D * D) * ((4664518695252762081361276504 : Int) * D) =
          (n1 - n2) * ((-(690627211385037298547738551962892852267586075469791719173459072596031701017399264062472192 : Int)) * 4664518695252762081361276504) * (D * D * D * D) := by
        simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
      rw [h, show ((-(690627211385037298547738551962892852267586075469791719173459072596031701017399264062472192 : Int)) * 4664518695252762081361276504) = -(3221443538955787693742639129943142603051027084828881274516979369381209677277149495924347379910667674547214343122976768 : Int) from by decide]
  ...
  have hT4 : (-(4299840983308505679614339668442 : Int)) * (n1 * n1 * n1 * n1) * D - (-(4299840983308505679614339668442 : Int)) * (n2 * n2 * n2 * n2) * D ≥
      -((n1 - n2) * (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) * (D * D * D * D)) := by
    ...
    have e2 : (-(4299840983308505679614339668442 : Int)) * (n1 - n2) * D * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D)) =
        -((n1 - n2) * (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) * (D * D * D * D)) := by
      have h : (-(4299840983308505679614339668442 : Int)) * (n1 - n2) * D * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D)) =
          (n1 - n2) * ((-(4299840983308505679614339668442 : Int)) * (50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int)) * (D * D * D * D) := by
        simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
      rw [h, show ((-(4299840983308505679614339668442 : Int)) * (50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int)) = -(218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) from by decide, Int.mul_neg, Int.neg_mul]
    omega
  -- T5 lower bound via the asymmetric quintic factor
  have hT5 : n1 * n1 * n1 * n1 * n1 - n2 * n2 * n2 * n2 * n2 ≥
      -((n1 - n2) * (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D)) := by
    rw [hd5]
    -- inner = (n1+n2)(n1²+n2²) is bounded by hH4; n1 inner ≥ -(UD)·4U³DDD
    have hxin : n1 * ((n1 + n2) * (n1 * n1 + n2 * n2)) ≥
        -(((2332259347626381040680638252 : Int) * D) * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D))) := by
      rcases Int.le_total 0 ((n1 + n2) * (n1 * n1 + n2 * n2)) with h | h
      · have s1 : n1 * ((n1 + n2) * (n1 * n1 + n2 * n2)) ≥
            (-((2332259347626381040680638252 : Int) * D)) * ((n1 + n2) * (n1 * n1 + n2 * n2)) :=
          mul_le_mul_right_nonneg hb1' h
        have s2 : (-((2332259347626381040680638252 : Int) * D)) * ((n1 + n2) * (n1 * n1 + n2 * n2)) ≥
            (-((2332259347626381040680638252 : Int) * D)) * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D)) := by
          refine mul_le_mul_left_nonpos hH4.2 (by omega)
        have e : (-((2332259347626381040680638252 : Int) * D)) * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D)) =
            -(((2332259347626381040680638252 : Int) * D) * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D))) := Int.neg_mul _ _
        omega
      · have s1 : n1 * ((n1 + n2) * (n1 * n1 + n2 * n2)) ≥
            ((2332259347626381040680638252 : Int) * D) * ((n1 + n2) * (n1 * n1 + n2 * n2)) :=
          mul_le_mul_right_nonpos hb1 h
        have s2 : ((2332259347626381040680638252 : Int) * D) * ((n1 + n2) * (n1 * n1 + n2 * n2)) ≥
            ((2332259347626381040680638252 : Int) * D) * (-((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D))) :=
          mul_le_mul_left_nonneg hH4.1 hUD
        have e : ((2332259347626381040680638252 : Int) * D) * (-((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D))) =
            -(((2332259347626381040680638252 : Int) * D) * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D))) := Int.mul_neg _ _
        omega
    ...
    have hmerge : ((2332259347626381040680638252 : Int) * D) * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D)) =
        (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D) := by
      have h : ((2332259347626381040680638252 : Int) * D) * ((50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int) * (D * D * D)) =
          ((2332259347626381040680638252 : Int) * (50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int)) * (D * D * D * D) := by
        simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
      rw [h, show ((2332259347626381040680638252 : Int) * (50744680040140494628632404491524039352162157045141941315210963455068760107946636032 : Int)) = (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) from by decide]
    have hkey : n1 * ((n1 + n2) * (n1 * n1 + n2 * n2)) + n2 * n2 * n2 * n2 ≥
        -((118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D)) := by
      rw [← hmerge]
      omega
    have step : (n1 - n2) * (n1 * ((n1 + n2) * (n1 * n1 + n2 * n2)) + n2 * n2 * n2 * n2) ≥
        (n1 - n2) * (-((118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D))) :=
      mul_le_mul_left_nonneg hkey hmono
    have e : (n1 - n2) * (-((118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D))) =
        -((n1 - n2) * (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D)) := by
      rw [Int.mul_neg]
      have h : (n1 - n2) * (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D) =
          (n1 - n2) * ((118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D)) := by
        rw [Int.mul_assoc]
      rw [h]
    omega
  ...
  have hsumQ : (n1 - n2) * (66099322585698201304896817119077614168377752650671880634963909888244721857603941759324591151523373370374573118109777920 : Int) * (D * D * D * D) -
      (n1 - n2) * (3221443538955787693742639129943142603051027084828881274516979369381209677277149495924347379910667674547214343122976768 : Int) * (D * D * D * D) -
      (n1 - n2) * (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) * (D * D * D * D) -
      (n1 - n2) * (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D) ≥ 0 := by
    have e1 : (n1 - n2) * (66099322585698201304896817119077614168377752650671880634963909888244721857603941759324591151523373370374573118109777920 : Int) * (D * D * D * D) -
        ...
        (n1 - n2) * (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) * (D * D * D * D) -
        (n1 - n2) * (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D) =
        (n1 - n2) * (62877660734337737772020784025015500924747260666218411269039976284492823465691796327333122064943157183923358508755602944 : Int) * (D * D * D * D) := by
      have h : (n1 - n2) * (66099322585698201304896817119077614168377752650671880634963909888244721857603941759324591151523373370374573118109777920 : Int) * (D * D * D * D) -
          ...
          (n1 - n2) * (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) * (D * D * D * D) -
          (n1 - n2) * (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D) =
          (n1 - n2) * ((66099322585698201304896817119077614168377752650671880634963909888244721857603941759324591151523373370374573118109777920 : Int) - (3221443538955787693742639129943142603051027084828881274516979369381209677277149495924347379910667674547214343122976768 : Int) - (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) - (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int)) * (D * D * D * D) := by
        generalize n1 - n2 = w
        have a1 : w * (66099322585698201304896817119077614168377752650671880634963909888244721857603941759324591151523373370374573118109777920 : Int) * (D * D * D * D) = (66099322585698201304896817119077614168377752650671880634963909888244721857603941759324591151523373370374573118109777920 : Int) * (w * (D * D * D * D)) := by
          simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
        have a2 : w * (3221443538955787693742639129943142603051027084828881274516979369381209677277149495924347379910667674547214343122976768 : Int) * (D * D * D * D) = (3221443538955787693742639129943142603051027084828881274516979369381209677277149495924347379910667674547214343122976768 : Int) * (w * (D * D * D * D)) := by
          simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
        have a3 : w * (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) * (D * D * D * D) = (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) * (w * (D * D * D * D)) := by
          simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
        have a4 : w * (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D) = (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (w * (D * D * D * D)) := by
          simp only [Int.mul_assoc, Int.mul_comm, Int.mul_left_comm]
  ...
  generalize (n1 - n2) * (3221443538955787693742639129943142603051027084828881274516979369381209677277149495924347379910667674547214343122976768 : Int) * (D * D * D * D) = g2 at *
  generalize (n1 - n2) * (218194054921473205884680738536345720046443799324765116631521030246779279758509548116438610549845998237328130502144 : Int) * (D * D * D * D) = g4 at *
  generalize (n1 - n2) * (118349754365927509283380434294859418455825263326290322713340441935355237426519005268058998665905762938100696064 : Int) * (D * D * D * D) = g5 at *
  omega
