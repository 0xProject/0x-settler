...
/-- `zero_value_for_split_t_int128()` returns the word `0`. -/
theorem call_zero_value_for_split_t_int128_direct
    (fuel extra : Nat) (shared : EvmYul.SharedState .Yul) (store : EvmYul.Yul.VarStore)
    (hlookup : shared.accountMap.find? shared.executionEnv.codeOwner =
      some (FormalYul.accountFor yulContract)) :
    EvmYul.Yul.call (fuel + (extra + 20)) [] (.some "zero_value_for_split_t_int128")
      (.some yulContract) (EvmYul.Yul.State.Ok shared store) =
    .ok (EvmYul.Yul.State.Ok shared store, [FormalYul.word 0]) := by
  rw [show fuel + (extra + 20) = (fuel + extra) + 20 by omega]
  rw [EvmYul.Yul.call.eq_def]
  simp only [hlookup, Option.getD_some, yulContract_functions,
    lookup_zero_value_for_split_t_int128]
  simp only [yulFunction_zero_value_for_split_t_int128,
    FormalYul.Preservation.functionDefinition_params_def,
    FormalYul.Preservation.functionDefinition_rets_def,
    FormalYul.Preservation.functionDefinition_body_def,
    EvmYul.Yul.State.initcall, EvmYul.Yul.State.mkOk]
...
/-- `convert_t_int256_to_t_int128(value)` returns the signed-128 cleanup of `value`. -/
theorem call_convert_int256_to_int128_direct
    (v fuel extra : Nat) (shared : EvmYul.SharedState .Yul) (store : EvmYul.Yul.VarStore)
    (hlookup : shared.accountMap.find? shared.executionEnv.codeOwner =
      some (FormalYul.accountFor yulContract)) :
    EvmYul.Yul.call (fuel + (extra + 120)) [FormalYul.word v]
      (.some "convert_t_int256_to_t_int128") (.some yulContract)
      (EvmYul.Yul.State.Ok shared store) =
    .ok (EvmYul.Yul.State.Ok shared store,
      [EvmYul.UInt256.signextend (FormalYul.word 15) (FormalYul.word v)]) := by
  rw [show fuel + (extra + 120) = (fuel + extra) + 120 by omega]
  rw [EvmYul.Yul.call.eq_def]
  simp only [hlookup, Option.getD_some, yulContract_functions,
    lookup_convert_t_int256_to_t_int128]
  simp only [yulFunction_convert_t_int256_to_t_int128,
    FormalYul.Preservation.functionDefinition_params_def,
    FormalYul.Preservation.functionDefinition_rets_def,
    FormalYul.Preservation.functionDefinition_body_def,
    EvmYul.Yul.State.initcall, EvmYul.Yul.State.mkOk]
  ...
  have h2 :=
    call_identity_direct (v := v) (fuel := fuel + extra) (extra := 94) (shared := shared)
      ...
      (hlookup := hlookup)
  have h3 :=
    call_cleanup_t_int128_direct (v := v) (fuel := fuel + extra) (extra := 96) (shared := shared)
      (store := Finmap.insert "value" (FormalYul.word v) (Inhabited.default : EvmYul.Yul.VarStore))
      (hlookup := hlookup)
  simp [FormalYul.word] at h1 h2 h3
  simp +decide [EvmYul.Yul.execCall.eq_def,
...
theorem call_cleanup_t_uint8_127_direct
    (fuel : Nat) (shared : EvmYul.SharedState .Yul) (store : EvmYul.Yul.VarStore)
    (hlookup : shared.accountMap.find? shared.executionEnv.codeOwner =
      some (FormalYul.accountFor yulContract)) :
    EvmYul.Yul.call (fuel + 20) [FormalYul.word 0x7f] (.some "cleanup_t_uint8")
      (.some yulContract) (EvmYul.Yul.State.Ok shared store) =
...
theorem call_cleanup_t_rational_MUL_EXP_RAY_HI_MINUS_ONE_direct
    (v fuel extra : Nat) (shared : EvmYul.SharedState .Yul) (store : EvmYul.Yul.VarStore)
    (hlookup : shared.accountMap.find? shared.executionEnv.codeOwner =
      some (FormalYul.accountFor yulContract)) :
    EvmYul.Yul.call (fuel + (extra + 20)) [FormalYul.word v]
      (.some "cleanup_t_rational_86989971160273136331862631243_by_1")
      (.some yulContract) (EvmYul.Yul.State.Ok shared store) =
    .ok (EvmYul.Yul.State.Ok shared store, [FormalYul.word v]) := by
  rw [show fuel + (extra + 20) = (fuel + extra) + 20 by omega]
  rw [EvmYul.Yul.call.eq_def]
  simp only [hlookup, Option.getD_some, yulContract_functions,
    lookup_cleanup_t_rational_86989971160273136331862631243_by_1]
  simp only [yulFunction_cleanup_t_rational_86989971160273136331862631243_by_1,
    FormalYul.Preservation.functionDefinition_params_def,
    FormalYul.Preservation.functionDefinition_rets_def,
    FormalYul.Preservation.functionDefinition_body_def,
    EvmYul.Yul.State.initcall, EvmYul.Yul.State.mkOk]
...
theorem call_convert_127_to_uint8_direct
    (fuel extra : Nat) (shared : EvmYul.SharedState .Yul) (store : EvmYul.Yul.VarStore)
    (hlookup : shared.accountMap.find? shared.executionEnv.codeOwner =
      some (FormalYul.accountFor yulContract)) :
    EvmYul.Yul.call (fuel + (extra + 120)) [FormalYul.word 0x7f]
      (.some "convert_t_rational_127_by_1_to_t_uint8")
      (.some yulContract) (EvmYul.Yul.State.Ok shared store) =
    .ok (EvmYul.Yul.State.Ok shared store, [FormalYul.word 0x7f]) := by
  rw [show fuel + (extra + 120) = (fuel + extra) + 120 by omega]
  rw [EvmYul.Yul.call.eq_def]
  simp only [hlookup, Option.getD_some, yulContract_functions,
    lookup_convert_t_rational_127_by_1_to_t_uint8]
  ...
  have h2 :=
    call_identity_direct (v := 0x7f) (fuel := fuel + extra) (extra := 94) (shared := shared)
      ...
      (hlookup := hlookup)
  have h3 :=
    call_cleanup_t_uint8_127_direct (fuel := fuel + extra + 96) (shared := shared)
      (store := Finmap.insert "value" (FormalYul.word 0x7f) (Inhabited.default : EvmYul.Yul.VarStore))
      (hlookup := hlookup)
  simp [FormalYul.word] at h1 h2 h3
  simp +decide [EvmYul.Yul.execCall.eq_def,
...
theorem call_convert_MUL_EXP_RAY_HI_MINUS_ONE_to_int256_direct
    (fuel extra : Nat) (shared : EvmYul.SharedState .Yul) (store : EvmYul.Yul.VarStore)
    (hlookup : shared.accountMap.find? shared.executionEnv.codeOwner =
      some (FormalYul.accountFor yulContract)) :
    EvmYul.Yul.call (fuel + (extra + 120))
      [FormalYul.word 86989971160273136331862631243]
      (.some "convert_t_rational_86989971160273136331862631243_by_1_to_t_int256")
      (.some yulContract) (EvmYul.Yul.State.Ok shared store) =
    .ok (EvmYul.Yul.State.Ok shared store,
      [FormalYul.word 86989971160273136331862631243]) := by
  rw [show fuel + (extra + 120) = (fuel + extra) + 120 by omega]
  rw [EvmYul.Yul.call.eq_def]
  simp only [hlookup, Option.getD_some, yulContract_functions,
    lookup_convert_t_rational_86989971160273136331862631243_by_1_to_t_int256]
  simp only [yulFunction_convert_t_rational_86989971160273136331862631243_by_1_to_t_int256,
    ...
    EvmYul.Yul.State.initcall, EvmYul.Yul.State.mkOk]
  have h1 :=
    call_cleanup_t_rational_MUL_EXP_RAY_HI_MINUS_ONE_direct
      (v := 86989971160273136331862631243) (fuel := fuel + extra) (extra := 92)
      (shared := shared)
      (store := Finmap.insert "value" (FormalYul.word 86989971160273136331862631243)
        (Inhabited.default : EvmYul.Yul.VarStore))
      (hlookup := hlookup)
  have h2 :=
    call_identity_direct (v := 86989971160273136331862631243)
      (fuel := fuel + extra) (extra := 94) (shared := shared)
      (store := Finmap.insert "value" (FormalYul.word 86989971160273136331862631243)
        (Inhabited.default : EvmYul.Yul.VarStore))
      (hlookup := hlookup)
  have h3 :=
    call_cleanup_t_int256_direct (v := 86989971160273136331862631243)
      (fuel := fuel + extra) (extra := 96) (shared := shared)
      (store := Finmap.insert "value" (FormalYul.word 86989971160273136331862631243)
        (Inhabited.default : EvmYul.Yul.VarStore))
      (hlookup := hlookup)
...
theorem call_shift_right_unsigned_dynamic_direct
  ...
  rw [EvmYul.Yul.call.eq_def]
  simp only [hlookup, Option.getD_some, yulContract_functions,
    lookup_shift_right_unsigned_dynamic]
...
theorem call_shift_right_t_uint256_t_uint8_127_direct
    ...
    (hlookup : shared.accountMap.find? shared.executionEnv.codeOwner =
      some (FormalYul.accountFor yulContract)) :
    EvmYul.Yul.call (fuel + (extra + 180)) [FormalYul.word value, FormalYul.word 0x7f]
      (.some "shift_right_t_uint256_t_uint8") (.some yulContract)
      (EvmYul.Yul.State.Ok shared store) =
    .ok (EvmYul.Yul.State.Ok shared store, [FormalYul.word (evmShr 0x7f value)]) := by
  rw [show fuel + (extra + 180) = (fuel + extra) + 180 by omega]
  rw [EvmYul.Yul.call.eq_def]
  simp only [hlookup, Option.getD_some, yulContract_functions,
    lookup_shift_right_t_uint256_t_uint8]
  simp only [yulFunction_shift_right_t_uint256_t_uint8,
    ...
    EvmYul.Yul.State.initcall, EvmYul.Yul.State.mkOk]
  have hbits :=
    call_cleanup_t_uint8_127_direct (fuel := fuel + extra + 156) (shared := shared)
      (store := Finmap.insert "value" (FormalYul.word value)
        (Finmap.insert "bits" (FormalYul.word 0x7f) (Inhabited.default : EvmYul.Yul.VarStore)))
      (hlookup := hlookup)
  have hvalue :=
    call_cleanup_t_uint256_direct (v := value) (fuel := fuel + extra) (extra := 151)
      (shared := shared)
      (store := Finmap.insert "bits" (FormalYul.word 0x7f)
        (Finmap.insert "value" (FormalYul.word value)
          (Finmap.insert "bits" (FormalYul.word 0x7f) (Inhabited.default : EvmYul.Yul.VarStore))))
      (hlookup := hlookup)
  have hshift :=
    call_shift_right_unsigned_dynamic_direct (bits := 0x7f) (value := value)
      ...
      (hlookup := hlookup)
  have hcleanup :=
    call_cleanup_t_uint256_direct (v := evmShr 0x7f value) (fuel := fuel + extra) (extra := 155)
      (shared := shared)
      (store := Finmap.insert "bits" (FormalYul.word 0x7f)
        (Finmap.insert "value" (FormalYul.word value)
          (Finmap.insert "bits" (FormalYul.word 0x7f) (Inhabited.default : EvmYul.Yul.VarStore))))
