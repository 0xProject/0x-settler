...
reduces the seam step to `arg1 ≤ 2·arg2`, which follows from the **`r0` doubling bound**
`r0Tree x1 + 3 ≤ 2·r0Tree x2` (`SeamR0Bound`; three integer units of the doubling gap cover the
