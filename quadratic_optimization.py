...
class FixedPointSolution:
    ...
    @property
    def a(self) -> float:
        return self.a_fp / SHIFT_SCALE

    @property
    def b(self) -> float:
        return self.b_fp / SHIFT_SCALE
...
def find_best_fixed_point(
    ...
    *,
    shift: int = SHIFT,
    a_bounds: Tuple[int, int] = (60, 95),
    b_bounds: Tuple[int, int] = (-14000, -8000),
    c_bounds: Tuple[int, int] = (90, 140),
...
def print_solution(solution: FixedPointSolution, buckets: List[int]) -> None:
    ...
    print("\n" + "=" * 70)
    print("BEST Q12 FIXED-POINT QUADRATIC")
    print("=" * 70)
...
def main() -> None:
    ...
    solution = find_best_fixed_point(buckets, thresholds)
    if solution is None:
