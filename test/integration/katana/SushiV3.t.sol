...
contract SushiV3KatanaIntegrationTest is SettlerBasePairTest {
    function setUp() public virtual override {
        ...
        // Source tokens from the SushiV3 pool (1.1 WETH of liquidity is plenty for our tiny swap).
    ...
    function _sushiV3Path() internal view returns (bytes memory) {
        // For Katana SushiV3 WETH/AUSD: AUSD is token0 (lower address), WETH is token1.
        // Selling WETH→AUSD is oneForZero, so the price limit is MAX_SQRT_RATIO-1.
