...
| AllowanceHolder VIP | Uniswap V3 | USDC/WETH | 130894 | 4.62%  |
...
| AllowanceHolder VIP | Uniswap V3 | DAI/WETH  | 118328 | 5.13%  |
...
| AllowanceHolder VIP | Uniswap V3 | USDT/WETH | 121149 | 5.02%  |
...
| ------------------------------------ | -------------- | --------- | ------ | ------ |
| execute                              | Uniswap V3 VIP | USDC/WETH | 130894 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | USDC/WETH | 139782 | 6.79%  |
|                                      |                |           |        |        |
| execute                              | Uniswap V3 VIP | DAI/WETH  | 118328 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | DAI/WETH  | 128791 | 8.84%  |
|                                      |                |           |        |        |
| execute                              | Uniswap V3 VIP | USDT/WETH | 121149 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | USDT/WETH | 135783 | 12.08% |
|                                      |                |           |        |        |
