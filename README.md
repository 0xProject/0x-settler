...
| AllowanceHolder VIP | Uniswap V3 | USDC/WETH | 127443 | 2.09%  |
...
| AllowanceHolder VIP | Uniswap V3 | DAI/WETH  | 114877 | 2.33%  |
...
| AllowanceHolder VIP | Uniswap V3 | USDT/WETH | 117698 | 2.28%  |
...
| ------------------------------------ | -------------- | --------- | ------ | ------- |
| execute                              | Uniswap V3 VIP | USDC/WETH | 127443 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | USDC/WETH | 139711 | 9.63%   |
| execute                              | OTC            | USDC/WETH | 109550 | -14.04% |
|                                      |                |           |        |         |
| execute                              | Uniswap V3 VIP | DAI/WETH  | 114877 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | DAI/WETH  | 128720 | 12.05%  |
| execute                              | OTC            | DAI/WETH  | 90076  | -21.59% |
|                                      |                |           |        |         |
| execute                              | Uniswap V3 VIP | USDT/WETH | 117698 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | USDT/WETH | 135712 | 15.31%  |
| execute                              | OTC            | USDT/WETH | 101188 | -14.03% |
|                                      |                |           |        |         |

| AllowanceHolder sell token fees | DEX | Pair      | Gas    | %      |
| ------------------------------- | --- | --------- | ------ | ------ |
| no fee                          | OTC | USDC/WETH | 109550 | 0.00%  |
| proportional fee                | OTC | USDC/WETH | 159519 | 45.61% |
| fixed fee                       | OTC | USDC/WETH | 157547 | 43.81% |
|                                 |     |           |        |        |
| no fee                          | OTC | DAI/WETH  | 90076  | 0.00%  |
| proportional fee                | OTC | DAI/WETH  | 131933 | 46.47% |
| fixed fee                       | OTC | DAI/WETH  | 130674 | 45.07% |
|                                 |     |           |        |        |
| no fee                          | OTC | USDT/WETH | 101188 | 0.00%  |
| proportional fee                | OTC | USDT/WETH | 148683 | 46.94% |
| fixed fee                       | OTC | USDT/WETH | 146995 | 45.27% |
|                                 |     |           |        |        |
