...
| Settler VIP (warm)  | Uniswap V3 | USDC/WETH | 132256 | 9.03%  |
| AllowanceHolder VIP | Uniswap V3 | USDC/WETH | 122105 | 0.66%  |
...
| Settler VIP (warm)  | Uniswap V3 | DAI/WETH  | 122927 | 9.78%  |
| AllowanceHolder VIP | Uniswap V3 | DAI/WETH  | 112776 | 0.71%  |
...
| Settler VIP (warm)  | Uniswap V3 | USDT/WETH | 134483 | 8.83%  |
| AllowanceHolder VIP | Uniswap V3 | USDT/WETH | 124332 | 0.62%  |
| UniswapRouter V3    | Uniswap V3 | USDT/WETH | 119778 | -3.07% |
|                     |            |           |        |        |
| Settler VIP (warm)  | Uniswap V3 | WETH/USDC | 154718 | NaN%   |
...
| Settler              | Uniswap V3 | USDC/WETH | 161098 | -32.83% |
| AllowanceHolder      | Uniswap V3 | USDC/WETH | 150955 | -37.06% |
|                      |            |           |        |         |
| 0x V4 TransformERC20 | Uniswap V3 | DAI/WETH  | 221474 | 0.00%   |
| Settler              | Uniswap V3 | DAI/WETH  | 149054 | -32.70% |
| AllowanceHolder      | Uniswap V3 | DAI/WETH  | 138911 | -37.28% |
|                      |            |           |        |         |
| 0x V4 TransformERC20 | Uniswap V3 | USDT/WETH | 237157 | 0.00%   |
| Settler              | Uniswap V3 | USDT/WETH | 164463 | -30.65% |
| AllowanceHolder      | Uniswap V3 | USDT/WETH | 154320 | -34.93% |
|                      |            |           |        |         |
| Settler              | Uniswap V3 | WETH/USDC | 180556 | NaN%    |
|                      |            |           |        |         |
...
| Settler           | Curve                 | USDT/WETH | 369314 | -7.77%  |
...
| ------- | ------- | --------- | ------ | ----- |
| Settler | DODO V1 | USDC/WETH | 296823 | 0.00% |
|         |         |           |        |       |
|         |         |           |        |       |
|         |         |           |        |       |
|         |         |           |        |       |
...
| ----------------- | ---------- | --------- | ------ | ----- |
| Settler - custody | Uniswap V3 | USDC/WETH | 169768 | 0.00% |
|                   |            |           |        |       |
| Settler - custody | Uniswap V3 | DAI/WETH  | 160439 | 0.00% |
|                   |            |           |        |       |
| Settler - custody | Uniswap V3 | USDT/WETH | 171995 | 0.00% |
|                   |            |           |        |       |
| Settler - custody | Uniswap V3 | WETH/USDC | 198220 | 0.00% |
|                   |            |           |        |       |

| Sell token fee | DEX        | Pair      | Gas    | %       |
| -------------- | ---------- | --------- | ------ | ------- |
| Settler        | Uniswap V3 | USDC/WETH | 175178 | 0.00%   |
|                |            |           |        |         |
| Settler        | Uniswap V3 | DAI/WETH  | 160419 | 0.00%   |
|                |            |           |        |         |
| Settler        | Uniswap V3 | USDT/WETH | 177604 | 0.00%   |
| Settler        | Curve      | USDT/WETH | 380387 | 114.18% |
|                |            |           |        |         |
| Settler        | Uniswap V3 | WETH/USDC | 191641 | 0.00%   |
|                |            |           |        |         |

| AllowanceHolder                      | DEX            | Pair      | Gas    | %       |
| ------------------------------------ | -------------- | --------- | ------ | ------- |
| execute                              | Uniswap V3 VIP | USDC/WETH | 122105 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | USDC/WETH | 135368 | 10.86%  |
| execute                              | RFQ            | USDC/WETH | 106575 | -12.72% |
|                                      |                |           |        |         |
| execute                              | Uniswap V3 VIP | DAI/WETH  | 112776 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | DAI/WETH  | 128877 | 14.28%  |
| execute                              | RFQ            | DAI/WETH  | 87101  | -22.77% |
|                                      |                |           |        |         |
| execute                              | Uniswap V3 VIP | USDT/WETH | 124332 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | USDT/WETH | 144601 | 16.30%  |
| execute                              | RFQ            | USDT/WETH | 98213  | -21.01% |
|                                      |                |           |        |         |
