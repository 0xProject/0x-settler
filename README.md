...
| Settler VIP (warm)  | Uniswap V3 | USDC/WETH | 134049 | 7.52%  |
...
| Settler VIP (warm)  | Uniswap V3 | DAI/WETH  | 121483 | 8.37%  |
| AllowanceHolder VIP | Uniswap V3 | DAI/WETH  | 113395 | 1.15%  |
...
| Settler VIP (warm)  | Uniswap V3 | USDT/WETH | 124314 | 8.18%  |
...
| Settler              | Uniswap V3 | USDC/WETH | 165158 | -32.48% |
| AllowanceHolder      | Uniswap V3 | USDC/WETH | 157219 | -35.72% |
|                      |            |           |        |         |
| 0x V4 TransformERC20 | Uniswap V3 | DAI/WETH  | 221527 | 0.00%   |
| Settler              | Uniswap V3 | DAI/WETH  | 148536 | -32.95% |
| AllowanceHolder      | Uniswap V3 | DAI/WETH  | 140597 | -36.53% |
|                      |            |           |        |         |
| 0x V4 TransformERC20 | Uniswap V3 | USDT/WETH | 228500 | 0.00%   |
| Settler              | Uniswap V3 | USDT/WETH | 155224 | -32.07% |
| AllowanceHolder      | Uniswap V3 | USDT/WETH | 147285 | -35.54% |
|                      |            |           |        |         |

| MetaTransactions | DEX        | Pair      | Gas    | %       |
| ---------------- | ---------- | --------- | ------ | ------- |
| 0x V4 Multiplex  | Uniswap V3 | USDC/WETH | 208118 | 0.00%   |
| Settler          | Uniswap V3 | USDC/WETH | 170927 | -17.87% |
|                  |            |           |        |         |
| 0x V4 Multiplex  | Uniswap V3 | DAI/WETH  | 195552 | 0.00%   |
| Settler          | Uniswap V3 | DAI/WETH  | 154305 | -21.09% |
|                  |            |           |        |         |
| 0x V4 Multiplex  | Uniswap V3 | USDT/WETH | 198359 | 0.00%   |
| Settler          | Uniswap V3 | USDT/WETH | 160993 | -18.84% |
|                  |            |           |        |         |
...
| ------- | ------- | --------- | ------ | ----- |
| Settler | DODO V1 | USDC/WETH | 303581 | 0.00% |
|         |         |           |        |       |
|         |         |           |        |       |
|         |         |           |        |       |
...
| ----------------- | ---------- | --------- | ------ | ----- |
| Settler - custody | Uniswap V3 | USDC/WETH | 172238 | 0.00% |
|                   |            |           |        |       |
| Settler - custody | Uniswap V3 | DAI/WETH  | 159672 | 0.00% |
|                   |            |           |        |       |
| Settler - custody | Uniswap V3 | USDT/WETH | 162503 | 0.00% |
|                   |            |           |        |       |

| Sell token fee | DEX        | Pair      | Gas    | %       |
| -------------- | ---------- | --------- | ------ | ------- |
| Settler        | Uniswap V3 | USDC/WETH | 181130 | 0.00%   |
|                |            |           |        |         |
| Settler        | Uniswap V3 | DAI/WETH  | 160452 | 0.00%   |
|                |            |           |        |         |
| Settler        | Uniswap V3 | USDT/WETH | 168916 | 0.00%   |
| Settler        | Curve      | USDT/WETH | 432419 | 156.00% |
|                |            |           |        |         |

| AllowanceHolder                      | DEX            | Pair      | Gas    | %       |
| ------------------------------------ | -------------- | --------- | ------ | ------- |
| execute                              | Uniswap V3 VIP | USDC/WETH | 125961 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | USDC/WETH | 140932 | 11.89%  |
| execute                              | RFQ            | USDC/WETH | 106534 | -15.42% |
|                                      |                |           |        |         |
| execute                              | Uniswap V3 VIP | DAI/WETH  | 113395 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | DAI/WETH  | 129941 | 14.59%  |
| execute                              | RFQ            | DAI/WETH  | 87060  | -23.22% |
|                                      |                |           |        |         |
| execute                              | Uniswap V3 VIP | USDT/WETH | 116226 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | USDT/WETH | 136944 | 17.83%  |
