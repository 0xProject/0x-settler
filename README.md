...
| AllowanceHolder VIP | Uniswap V3 | USDC/WETH | 128292 | 2.54%  |
...
| AllowanceHolder VIP | Uniswap V3 | DAI/WETH  | 115726 | 2.82%  |
...
| AllowanceHolder VIP | Uniswap V3 | USDT/WETH | 118547 | 2.76%  |
...
| Settler          | Uniswap V3 | USDT/WETH | 160569 | -34.11% |
|                  |            |           |        |         |
...
| ------------------------------------ | -------------- | --------- | ------ | ------ |
| execute                              | Uniswap V3 VIP | USDC/WETH | 128292 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | USDC/WETH | 139682 | 8.88%  |
|                                      |                |           |        |        |
| execute                              | Uniswap V3 VIP | DAI/WETH  | 115726 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | DAI/WETH  | 128691 | 11.20% |
|                                      |                |           |        |        |
| execute                              | Uniswap V3 VIP | USDT/WETH | 118547 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | USDT/WETH | 135683 | 14.46% |
|                                      |                |           |        |        |
