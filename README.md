...
| AllowanceHolder VIP | Uniswap V3 | USDC/WETH | 131557 | 5.15%  |
...
| AllowanceHolder VIP | Uniswap V3 | DAI/WETH  | 118970 | 5.70%  |
...
| AllowanceHolder VIP | Uniswap V3 | USDT/WETH | 121808 | 5.59%  |
...
| ------------------------------------ | -------------- | --------- | ------ | ------ |
| execute                              | Uniswap V3 VIP | USDC/WETH | 131557 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | USDC/WETH | 140380 | 6.71%  |
|                                      |                |           |        |        |
| execute                              | Uniswap V3 VIP | DAI/WETH  | 118970 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | DAI/WETH  | 129389 | 8.76%  |
|                                      |                |           |        |        |
| execute                              | Uniswap V3 VIP | USDT/WETH | 121808 | 0.00%  |
| Settler - external move then execute | Uniswap V3     | USDT/WETH | 136398 | 11.98% |
|                                      |                |           |        |        |
