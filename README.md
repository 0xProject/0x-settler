...
| AllowanceHolder VIP | Uniswap V3 | USDC/WETH | 127786 | 2.37%  |
...
| AllowanceHolder VIP | Uniswap V3 | DAI/WETH  | 115220 | 2.63%  |
...
| AllowanceHolder VIP | Uniswap V3 | USDT/WETH | 118038 | 2.58%  |
...
| ------------------------------------ | -------------- | --------- | ------ | ------- |
| execute                              | Uniswap V3 VIP | USDC/WETH | 127786 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | USDC/WETH | 139407 | 9.09%   |
| execute                              | OTC            | USDC/WETH | 109493 | -14.32% |
|                                      |                |           |        |         |
| execute                              | Uniswap V3 VIP | DAI/WETH  | 115220 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | DAI/WETH  | 128416 | 11.45%  |
| execute                              | OTC            | DAI/WETH  | 90019  | -21.87% |
|                                      |                |           |        |         |
| execute                              | Uniswap V3 VIP | USDT/WETH | 118038 | 0.00%   |
| Settler - external move then execute | Uniswap V3     | USDT/WETH | 135405 | 14.71%  |
| execute                              | OTC            | USDT/WETH | 101131 | -14.32% |
|                                      |                |           |        |         |

| AllowanceHolder sell token fees | DEX | Pair      | Gas    | %      |
| ------------------------------- | --- | --------- | ------ | ------ |
| no fee                          | OTC | USDC/WETH | 109493 | 0.00%  |
| proportional fee                | OTC | USDC/WETH | 159528 | 45.70% |
| fixed fee                       | OTC | USDC/WETH | 157556 | 43.90% |
|                                 |     |           |        |        |
| no fee                          | OTC | DAI/WETH  | 90019  | 0.00%  |
| proportional fee                | OTC | DAI/WETH  | 131942 | 46.57% |
| fixed fee                       | OTC | DAI/WETH  | 130683 | 45.17% |
|                                 |     |           |        |        |
| no fee                          | OTC | USDT/WETH | 101131 | 0.00%  |
| proportional fee                | OTC | USDT/WETH | 148692 | 47.03% |
| fixed fee                       | OTC | USDT/WETH | 147004 | 45.36% |
|                                 |     |           |        |        |
