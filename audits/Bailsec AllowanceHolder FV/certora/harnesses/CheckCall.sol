...
library CheckCall {
     ...
     * @param minReturnBytes `success` is false if the call doesnt return at least this much return
     *                       data
     */
    function checkCall(address target, bytes memory data, uint256 minReturnBytes) internal view returns (bool success) {
        ...
        //     // `verbatim` cant work in inline assembly. Assignment of a value to a variable costs
        ...
        //             // The absence of returndata means that its possible that either we called an
        ...
        //         // means that the call didnt revert due to out-of-gas, if it reverted. We can omit
        //         // a bunch of checks.
        ...
        // gas can not be modeled by certora => replacement function ignores it
        return checkCallSolidity(target, data, minReturnBytes);
    }
